...
beeware_theme.init(
    project_name="Python-Apple-Support",
...
linkcheck_ignore = [
    ...
    r"^https://github.com/beeware/Python-Apple-Support/issues/\d+$",
    r"^https://github.com/beeware/Python-Apple-Support/pull/\d+$",
]
...
# documentation.
# html_theme_options = {
#      "project_baseurl": "https://github.com/beeware/Python-Apple-Support",
# }
...
html_title = f"Python Apple Support"
...
latex_documents = [
    ("index", "PythonAppleSupport.tex", "Python Apple Support Documentation", "Russell Keith-Magee", "manual"),
]
...
man_pages = [("index", "python-apple-support", "Python Apple Support Documentation", ["Russell Keith-Magee"], 1)]
...
texinfo_documents = [
    (
        "index",
        "python_apple_support",
        "Python Apple Support Documentation",
        "Russell Keith-Magee",
