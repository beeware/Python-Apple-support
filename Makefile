...
# Build Python
$$(PYTHON_DIR-$1)/dist/lib/libpython$(PYTHON_VER).a: build/$2/Support/OpenSSL build/$2/Support/BZip2 $$(PYTHON_DIR-$1)/Makefile
	# Build target Python
...
HOST_PYTHON=$(CURDIR)/build/macOS/python/bin/python
HOST_PIP=$(CURDIR)/build/macOS/python/bin/pip
